...
// TODO: Добавить проверку, имеет ли пользователь доступ к board_id, указанному в GET-параметре
?>
<!DOCTYPE html>
<html>
<head>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMember() {
        ...
        fetch('boards.php?action=add_member', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function loadTasks() {
        fetch(`task.php?action=get&board_id=${boardId}`)
            .then(res => res.json())
            .then(tasks => {
                ...
                if (!tasks.length) {
                    ...
                    document.querySelectorAll('.status-select').forEach(select => {
                        select.addEventListener('change', e => {
                            ...
                            fetch('task.php?action=update_status', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                    ...
                    document.querySelectorAll('.priority-select').forEach(select => {
                        select.addEventListener('change', e => {
                            ...
                            fetch('task.php?action=update_priority', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                    ...
                    document.querySelectorAll('.deadline-input').forEach(input => {
                        input.addEventListener('change', e => {
                            ...
                            fetch('task.php?action=update_deadline', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
